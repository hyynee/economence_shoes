...
export class PaymentService {
    ...
    constructor() {
        this.stripe = new Stripe('sk_test_51QUamvJwBLm6t1fhXJgepzoJWxiwr5Mf5ylqJ2raMfNREiN2sx82ibQjEe9DVZe7xYtJ7w0LlaZv7LIy4OuFDghq006thX2kyS');
    ...
    async create(accountId: number, createPaymentDto: any) {
        ...
        const lineItems = cartItems.map(item => {
            ...
            const imageUrlBE = "https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png";
    ...
    async handleCheckoutSessionCompleted(session: Stripe.Checkout.Session) {
        try {
            ...
            const lineItems = await this.stripe.checkout.sessions.listLineItems(session.id, { limit: 100 });
